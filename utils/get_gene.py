...
def get_gene_abbreviations_in_bin(bin_id, node_bed_path, gtf_file_path):
    ...
    if node_intervals.empty:
        print(f"No intervals found for bin {bin_id}.")
        return []
...
genes = get_gene_abbreviations_in_bin(4276, "data/bin_map_human_100000.bed", "data/gencode.v38.annotation.gtf")
